...
[HarmonyPatch(typeof(MouseoverReadout), nameof(MouseoverReadout.MouseoverReadoutOnGUI), null)]
internal static class MouseoverReadout_MouseoverReadoutOnGUI
{
        ...
        foreach (var instr in original)
        {
                ...
                (MethodInfo)instr.operand == typeof(Def).GetMethod("get_LabelCap"))
            {
                ...
                yield return new CodeInstruction(OpCodes.Call,
                    typeof(MouseoverReadout_MouseoverReadoutOnGUI).GetMethod(nameof(HandleLabelQuery)));
